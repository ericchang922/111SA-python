...
@app.route('/road-veiw', methods=['GET', 'POST'])
def roadVeiw():
...
def whichRoad(roadId):
    ...
    if roadId == 1:
        ...
        #偏移量
        offset = 8
        carno = cal(cap, x_right, x_left, min_w, min_h, line_high, cars, ambulance_classifier, offset)
    elif roadId == 2:
...
def cal(cap, x_right, x_left, min_w, min_h, line_high, cars, ambulance_classifier, offset):
    carno = 0
    # 引入去背景函数
